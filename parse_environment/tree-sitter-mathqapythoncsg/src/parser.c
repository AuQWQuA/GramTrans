...
enum ts_symbol_identifiers {
  ...
  sym_escape_interpolation = 28,
  sym_string_end = 29,
  sym_module = 30,
  sym__statement = 31,
  sym__simple_statements = 32,
  sym_expression_statement = 33,
  sym_assignment = 34,
  sym_pattern = 35,
  sym__right_hand_side = 36,
  sym_expression = 37,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 668, lookahead)) ADVANCE(28);
      END_STATE();
    case 1:
    ...
    case 28:
      ...
      if (set_contains(sym_identifier_character_set_2, 776, lookahead)) ADVANCE(28);
      END_STATE();
    case 29:
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [31] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_operator, 3, 0, 6),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_operator, 3, 0, 6),
  ...
  [49] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_operator, 2, 0, 3),
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_operator, 2, 0, 3),
  [53] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 2, 0, 4),
  [55] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 2, 0, 4),
  [57] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_primary_expression, 1, 0, 0),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_primary_expression, 1, 0, 0),
  [61] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0),
  [63] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(62),
  [66] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  ...
  [73] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 1, 0, 0),
  ...
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 3, 0, 7),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 3, 0, 7),
  ...
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 2, 0, 0),
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [112] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2, 0, 0),
  [114] = {.entry = {.count = 1, .reusable = true}}, SHIFT(37),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 1, 0, 0),
  [118] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_statements, 2, 0, 0),
  [120] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__simple_statements, 2, 0, 0),
  [122] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  ...
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 4, 0, 8),
  [139] = {.entry = {.count = 1, .reusable = true}}, SHIFT(26),
  [141] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 1, 0, 0),
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_expression_statement, 1, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = true}}, SHIFT(2),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda_parameters, 1, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_import_statement, 2, 0, 1),
  [157] = {.entry = {.count = 1, .reusable = true}}, SHIFT(38),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 5, 0, 5),
  [161] = {.entry = {.count = 1, .reusable = true}}, SHIFT(6),
  [163] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__import_list, 1, 0, 2),
  [167] = {.entry = {.count = 1, .reusable = true}}, SHIFT(56),
  [169] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_dotted_name, 1, 0, 0),
...
extern "C" {
#endif
void *tree_sitter_mathqapythoncsg_external_scanner_create(void);
void tree_sitter_mathqapythoncsg_external_scanner_destroy(void *);
bool tree_sitter_mathqapythoncsg_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_mathqapythoncsg_external_scanner_serialize(void *, char *);
void tree_sitter_mathqapythoncsg_external_scanner_deserialize(void *, const char *, unsigned);
...
TS_PUBLIC const TSLanguage *tree_sitter_mathqapythoncsg(void) {
  static const TSLanguage language = {
    ...
    .external_scanner = {
      ...
      tree_sitter_mathqapythoncsg_external_scanner_create,
      tree_sitter_mathqapythoncsg_external_scanner_destroy,
      tree_sitter_mathqapythoncsg_external_scanner_scan,
      tree_sitter_mathqapythoncsg_external_scanner_serialize,
      tree_sitter_mathqapythoncsg_external_scanner_deserialize,
    },
