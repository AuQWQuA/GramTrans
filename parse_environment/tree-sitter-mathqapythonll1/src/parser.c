...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym__simple_statements] = STATE(50),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [79] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_attribute, 4, 0, 7),
  [81] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_attribute, 4, 0, 7),
  ...
  [87] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_binary_operator, 3, 0, 5),
  [89] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_binary_operator, 3, 0, 5),
  ...
  [95] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_unary_operator, 2, 0, 4),
  [97] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_unary_operator, 2, 0, 4),
  [99] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_call, 3, 0, 6),
  [101] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_call, 3, 0, 6),
  ...
  [109] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(115),
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_module_repeat1, 2, 0, 0), SHIFT_REPEAT(54),
  ...
  [125] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2, 0, 0), SHIFT_REPEAT(5),
  [128] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_argument_list_repeat1, 2, 0, 0),
  [130] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__simple_statements, 2, 0, 0),
  [132] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__simple_statements, 2, 0, 0),
  [134] = {.entry = {.count = 1, .reusable = true}}, SHIFT(82),
  [136] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 1, 0, 0),
  ...
  [146] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__parameters, 2, 0, 0),
  [148] = {.entry = {.count = 1, .reusable = true}}, SHIFT(116),
  [150] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2, 0, 0), SHIFT_REPEAT(82),
  [153] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym__parameters_repeat1, 2, 0, 0),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_lambda, 4, 0, 8),
  ...
  [167] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_assignment, 3, 0, 3),
  ...
  [207] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_pattern, 1, 0, 0),
};
...
extern "C" {
#endif
void *tree_sitter_mathqapythonll1_external_scanner_create(void);
void tree_sitter_mathqapythonll1_external_scanner_destroy(void *);
bool tree_sitter_mathqapythonll1_external_scanner_scan(void *, TSLexer *, const bool *);
unsigned tree_sitter_mathqapythonll1_external_scanner_serialize(void *, char *);
void tree_sitter_mathqapythonll1_external_scanner_deserialize(void *, const char *, unsigned);
...
TS_PUBLIC const TSLanguage *tree_sitter_mathqapythonll1(void) {
  static const TSLanguage language = {
    ...
    .external_scanner = {
      ...
      tree_sitter_mathqapythonll1_external_scanner_create,
      tree_sitter_mathqapythonll1_external_scanner_destroy,
      tree_sitter_mathqapythonll1_external_scanner_scan,
      tree_sitter_mathqapythonll1_external_scanner_serialize,
      tree_sitter_mathqapythonll1_external_scanner_deserialize,
    },
